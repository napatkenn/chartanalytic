    ...
    <>
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            <h3 id="upgrade-confirm-title" className="text-xl font-bold text-gray-900">
              Upgrade to {plan.name}
            </h3>
            ...
            <div className="mt-4 rounded-xl border border-gray-200 bg-gray-50 p-4">
              ...
              <span className="text-sm text-gray-500">/ {plan.periodLabel}</span>
      ...
      {showSuccess && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div
            className="relative w-full max-w-sm rounded-2xl border border-gray-200 bg-white p-6 shadow-xl text-center"
            role="dialog"
            aria-modal="true"
            aria-labelledby="upgrade-success-title"
          >
            <p className="text-4xl mb-3">✓</p>
            <h3 id="upgrade-success-title" className="text-xl font-bold text-gray-900">
              New plan activated
            </h3>
            <p className="mt-2 text-sm text-gray-600">
